...
# Configure data loader
dataset = datasets.ImageFolder(root='/home/wonjun/Desktop/PaDiM-Anomaly-Detection-Localization-master-main/PyTorch-GAN/data/SOFC/crack',
                               transform=transforms.Compose([
...
os.makedirs("generated_images", exist_ok=True)
for i in range(n_images):
    save_image(gen_imgs[i].data, f"generated_images/crack_generated_images/{i}.png", normalize=True)
