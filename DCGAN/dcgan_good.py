...
os.makedirs("pkl_test", exist_ok=True)
...
# Configure data loader
dataset = datasets.ImageFolder(root='/home/wonjun/Desktop/PaDiM-Anomaly-Detection-Localization-master-main/PyTorch-GAN/data/SOFC/good',
                               transform=transforms.Compose([
...
for epoch in range(opt.n_epochs):
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            save_image(gen_imgs.data[:25], "images/good/dcgan/%d.png" % batches_done, nrow=5, normalize=True)
...
os.makedirs("generated_images", exist_ok=True)
for i in range(n_images):
    save_image(gen_imgs[i].data, f"generated_images/good/dcgan/{i}.png", normalize=True)
