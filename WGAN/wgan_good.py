    ...
    for i, (imgs, _) in enumerate(dataloader):
        ...
        if i % opt.n_critic == 0:
            ...
            if batches_done % opt.sample_interval == 0:
                save_image(gen_imgs.data[:25], "images/good/wgan/%d.png" % batches_done, nrow=5, normalize=True)
...
os.makedirs("generated_images", exist_ok=True)
for i in range(n_images):
    save_image(gen_imgs[i].data, f"generated_images/good/wgan/{i}.png", normalize=True)
